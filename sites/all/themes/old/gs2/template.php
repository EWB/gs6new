 ...
 *   entirety and paste it here, changing the prefix from theme_ to gs2_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: gs2_breadcrumb()
 *
 *   where gs2 is the name of your sub-theme. For example, the
...
if (theme_get_setting('gs2_fixed')) {
 ...
 */
function gs2_theme(&$existing, $type, $theme, $path) {
...
function gs2_preprocess(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
function gs2_preprocess_page(&$vars, $hook) {
  ...
  if ($pos) {
    ...
    foreach ($vars['primary_links'] as $index => $link) {
      if ($i <= $active_tab) { //at or before the active tab put left drop shadows
        $primary_links["$index ltab$i"] = $link;
      }else{ //after the active tab
        $primary_links["$index rtab$i"] = $link;
      }
      $i++;
    }
 ...
 */
/* -- Delete this line if you want to use this function
function gs2_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gs2_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function gs2_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
/*
...
function print_bugs() {
	...
	?>
	<div id="debug" align="left" style="white-space:pre;">
		<?php foreach ($bugs as $name => $info) {echo "<p>$name:<br />"; print_r($info); echo "</p>";} ?>
	</div><?php
	unset($bugs);
}
/*
